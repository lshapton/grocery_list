class ProductVariantsController < ApplicationController
  ...
  private
    ...
    def product_variant_params
      params.require(:product_variant).permit(:external_id, :product_external_id, :title, :price, :sku, :position, :inventory_policy, :fulfillment_service, :inventory_management, :barcode, :image_id, :inventory_quantity, :weight, :weight_unit, :old_inventory_quantity, :requires_shipping)
    end
end
